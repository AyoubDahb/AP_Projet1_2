...
class InterventionControleur
{
    ...
    {
        return $this->intervention->getTotalIncidents();
    }

    // le nombre de clients avec un ticket ouvert
    public function getClientsWithOpenTickets()
    {
        return $this->intervention->getClientsWithOpenTickets();
    }

    // le nombre de tickets ouverts depuis plus d'un jour
    public function getTicketsOpenMoreThanOneDay()
    {
        return $this->intervention->getTicketsOpenMoreThanOneDay();
    }
}
